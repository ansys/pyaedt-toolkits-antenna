...
from ansys.aedt.toolkits.antennas.backend.models.horn import Corrugated
from ansys.aedt.toolkits.antennas.backend.models.horn import EPlane
from ansys.aedt.toolkits.antennas.backend.models.horn import Elliptical
...
class TestClass(BasisTest, object):
    ...
    def test_01a_conical(self):
        ...
        ohorn1 = self.aedtapp.add_from_toolkit(Conical,
                                               draw=True,
                                               frequency=1.0,
                                               huygens_box=True,
    ...
    def test_03_corrugated(self):
        ...
        ohorn1 = self.aedtapp.add_from_toolkit(
            Corrugated, draw=True, frequency=10.0, length_unit=self.aedtapp.modeler.model_units,
        )
        assert ohorn1
        assert ohorn1.object_list
        for comp in ohorn1.object_list.values():
    ...
    def test_04_elliptical(self):
        ...
        self.aedtapp.solution_type = "Modal"
        ohorn1 = self.aedtapp.add_from_toolkit(
            Elliptical, draw=True, frequency=10.0, length_unit=self.aedtapp.modeler.model_units
        )
        assert ohorn1
        assert ohorn1.object_list
        for comp in ohorn1.object_list.values():
    ...
    def test_05_eplane(self):
        ...
        self.aedtapp.solution_type = "Modal"
        ohorn1 = self.aedtapp.add_from_toolkit(EPlane, draw=True, frequency=10.0,
                                               length_unit=self.aedtapp.modeler.model_units)
        assert ohorn1
        assert ohorn1.object_list
        for comp in ohorn1.object_list.values():
    ...
    def test_06_hplane(self):
        ...
        self.aedtapp.solution_type = "Modal"
        ohorn1 = self.aedtapp.add_from_toolkit(HPlane, draw=True, frequency=10.0,
                                               length_unit=self.aedtapp.modeler.model_units)
        assert ohorn1
        assert ohorn1.object_list
        for comp in ohorn1.object_list.values():
    ...
    def test_07_pyramidal(self):
        ...
        self.aedtapp.solution_type = "Modal"
        ohorn1 = self.aedtapp.add_from_toolkit(
            Pyramidal, draw=True, frequency=10.0, length_unit=self.aedtapp.modeler.model_units
        )
        assert ohorn1
        assert ohorn1.object_list
        for comp in ohorn1.object_list.values():
    ...
    def test_08_quadridged(self):
        ...
        self.aedtapp.solution_type = "Modal"
        ohorn1 = self.aedtapp.add_from_toolkit(
            QuadRidged, draw=True, frequency=10.0, length_unit=self.aedtapp.modeler.model_units
        )
        assert ohorn1
        assert ohorn1.object_list
        for comp in ohorn1.object_list.values():
