...
class Ui_AntennaSynthesis(object):
    def setupUi(self, AntennaSynthesis):
        if not AntennaSynthesis.objectName():
            AntennaSynthesis.setObjectName("AntennaSynthesis")
        ...
        self.antenna_input.setObjectName("antenna_input")
        ...
        self.right_settings_layout.setObjectName("right_settings_layout")
        self.right_settings_layout.setContentsMargins(6, -1, 6, -1)
        self.top_antenna_options_frame = QFrame(AntennaSynthesis)
        self.top_antenna_options_frame.setObjectName("top_antenna_options_frame")
        self.top_antenna_settings_layout = QHBoxLayout(self.top_antenna_options_frame)
        self.top_antenna_settings_layout.setObjectName("top_antenna_settings_layout")
        ...
        self.top_antenna_settings_options_layout.setObjectName("top_antenna_settings_options_layout")
        ...
        self.length_unit_layout.setObjectName("length_unit_layout")
        self.length_unit_label = QLabel(self.top_antenna_options_frame)
        self.length_unit_label.setObjectName("length_unit_label")
        ...
        self.length_unit_label.setMinimumSize(QSize(75, 0))
        ...
        self.frequency_unit_layout.setObjectName("frequency_unit_layout")
        self.frequency_unit_label = QLabel(self.top_antenna_options_frame)
        self.frequency_unit_label.setObjectName("frequency_unit_label")
        ...
        self.frequency_unit.setObjectName("frequency_unit")
        ...
        self.bottom_antenna_options_frame.setObjectName("bottom_antenna_options_frame")
        self.botton_antenna_settings_layout = QHBoxLayout(self.bottom_antenna_options_frame)
        self.botton_antenna_settings_layout.setObjectName("botton_antenna_settings_layout")
        ...
        self.botton_image_frame.setObjectName("botton_image_frame")
        self.botton_image_layout = QGridLayout(self.botton_image_frame)
        self.botton_image_layout.setObjectName("botton_image_layout")
        ...
        self.botton_image_layout_2.setObjectName("botton_image_layout_2")
    ...
    def retranslateUi(self, AntennaSynthesis):
        AntennaSynthesis.setWindowTitle(QCoreApplication.translate("AntennaSynthesis", "Form", None))
        self.component_3d.setText(QCoreApplication.translate("AntennaSynthesis", "3D Component", None))
        self.create_hfss_setup.setText(QCoreApplication.translate("AntennaSynthesis", "Create HFSS Setup", None))
        self.lattice_pair.setText(QCoreApplication.translate("AntennaSynthesis", "Lattice pair", None))
        self.sweep_label.setText(QCoreApplication.translate("AntennaSynthesis", "Sweep Bandwidth %", None))
        self.slider_value.setText(QCoreApplication.translate("AntennaSynthesis", "20", None))
        self.length_unit_label.setText(QCoreApplication.translate("AntennaSynthesis", "Length Unit", None))
        self.length_unit.setText(QCoreApplication.translate("AntennaSynthesis", "cm", None))
        self.length_unit.setPlaceholderText("")
        self.frequency_unit_label.setText(QCoreApplication.translate("AntennaSynthesis", "Frequency Unit", None))
        self.frequency_unit.setText(QCoreApplication.translate("AntennaSynthesis", "GHz", None))
